 ...
 $.fn.imgcode = function (options) { 
  ...
  return this.each(function () { 
   ...
   var html = '<div class="code-k-div">' + 
    ...
    '<div class="code-mask"><img src="images/icon/codejt.png"></div>' + 
    '<img src="images/icon/loginicon.png" style="width:300px;height:160px;"></div>' + 
   ...
   function checkcode(code){ 
    ...
    setTimeout(function(){ 
     if(!iscur){ 
      ...
      $this.html('<input type="text" class="form-control" value="验证成功" readonly="readonly" style="color:red;">'); 
     }else{ 
